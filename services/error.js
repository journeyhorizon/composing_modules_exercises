...
export const LISTING_TYPE_IS_NOT_SUBSCRIPTION_ERROR = 'LISTING_TYPE_IS_NOT_SUBSCRIPTION_ERROR';
export const TRANSACTION_TYPE_IS_NOT_SUBSCRIPTION_ERROR = 'TRANSACTION_TYPE_IS_NOT_SUBSCRIPTION_ERROR';
